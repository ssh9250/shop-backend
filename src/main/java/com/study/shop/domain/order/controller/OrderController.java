...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<OrderDetailDto>> acceptOrder(@PathVariable Long id, @AuthenticationPrincipal CustomUserDetails userDetails) {
    ...
    public ResponseEntity<ApiResponse<OrderDetailDto>> startDelivery(@PathVariable Long id, @AuthenticationPrincipal CustomUserDetails userDetails) {
    ...
    public ResponseEntity<ApiResponse<OrderDetailDto>> completeOrder(@PathVariable Long id, @AuthenticationPrincipal CustomUserDetails userDetails) {
