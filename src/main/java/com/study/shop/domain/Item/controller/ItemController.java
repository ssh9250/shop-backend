...
import com.study.shop.domain.Item.service.InstrumentService;
...
public class ItemController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<Long>> createInstrument(@RequestBody CreateItemRequestDto request) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<ItemResponseDto>> getInstrument(@PathVariable Long id) {
    ...
    @GetMapping("/me")
    public ResponseEntity<ApiResponse<List<ItemResponseDto>>> getMyInstruments(@AuthenticationPrincipal CustomUserDetails userDetails) {
